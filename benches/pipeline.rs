...
mod fixture {
    use super::{
        CTA_COUNTERS_BYTES, CTA_COUNTERS_PACKETS, CTA_IP_V4_DST, CTA_IP_V4_SRC, CTA_PROTO_DST_PORT,
        CTA_PROTO_NUM, CTA_PROTO_SRC_PORT, CTA_TUPLE_IP, CTA_TUPLE_PROTO, NFNL_SUBSYS_CTNETLINK,
        NLA_ALIGNTO, NLA_HDRLEN, NLMSG_HDRLEN,
    };
    include!(concat!(
...
use fixture::{attr, counters, ct_event, tuple};
...
fn nat_event(index: u32, msg_type: u8) -> Vec<u8> {
    ...
    ct_event(msg_type, NFPROTO_IPV4, &attrs)
}
